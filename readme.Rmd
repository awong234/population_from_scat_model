...
Note that estimation improves dramatically after approximately 25% of the sites are revisited. This was a key result; prior simulations did not incorporate replication of observation of grid cells, and as the graphs display, the parameters were not identifiable when the proportion of grid cells re-visited was near 0%. Analysis of the real dataset proceeded once this insight was generated, having substantial replication of grid cell observation in the dataset.