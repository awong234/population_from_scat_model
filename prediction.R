...
save(outList, file = 'predictionOutput/null/prediction_NULL_1000m_all_elev.Rdata')
...
save(outList, file = 'predictionOutput/null/prediction_NULL_100m_all_elev.Rdata')
...
save(outList, file = 'predictionOutput/dCov/prediction_dcov_100m_all_elev.Rdata')
...
save(outList, file = 'predictionOutput/cont/prediction_cont_100m_all_elev.Rdata')

if(!skip){
  
  load('predictionOutput/cont/prediction_cont_100m_all_elev.Rdata')
...
save(pr_grid_sc_elev, file = 'predict_grid_scaled_100_elev_99.Rdata')
...
save(outList, file = 'predictionOutput/cont/prediction_cont_100m_elev_trim_99.Rdata')

if(!skip){
  
  load('predictionOutput/cont/prediction_cont_100m_elev_trim.Rdata')
...
save(outList, file = 'predictionOutput/null/prediction_NULL_100m_elev_trim_99.Rdata')
...
save(outList, file = 'predictionOutput/cont/prediction_cont_100m_elev_mean_99.Rdata')
...
save(pr_grid_sc_elev, file = 'predict_grid_scaled_100_elev_95.Rdata')
...
save(outList, file = 'predictionOutput/cont/prediction_cont_100m_elev_trim_95.Rdata')
...
save(outList, file = 'predictionOutput/null/prediction_NULL_100m_elev_trim_95.Rdata')
...
save(outList, file = 'predictionOutput/cont/prediction_cont_100m_elev_mean_95.Rdata')
